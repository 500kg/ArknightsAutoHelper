...
def initialize():
    ...
    ep07 = {}
    ep07['7-1'] = vec(0, 0)
    ep07['7-2'] = ep07['7-1'] + vec(276, 0)
    ep07['7-3'] = ep07['7-1'] + vec(481, -115)
    ep07['7-4'] = ep07['7-1'] + vec(609, 110)
    ep07['7-5'] = ep07['7-4'] + vec(292, 0)
    ep07['7-6'] = ep07['7-4'] + vec(626, -84)
    ep07['7-8'] = ep07['7-6'] + vec(462, 0)
    ep07['7-9'] = ep07['7-6'] + vec(672, -210)
    ep07['7-10'] = ep07['7-6'] + vec(969, -210)
    ep07['7-11'] = ep07['7-10'] + vec(224, 109)
    ep07['7-12'] = ep07['7-10'] + vec(445, 216)
    ep07['7-13'] = ep07['7-10'] + vec(634, 109)
    ep07['7-14'] = ep07['7-10'] + vec(829, 216)
    ep07['7-15'] = ep07['7-10'] + vec(1042, 109)
    
    

    stage_maps['ep07'] = ep07
    map_anchors['ep07'] = ['7-1', '7-4', '7-6', '7-10', '7-15']
